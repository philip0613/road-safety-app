...
app.post('/api/analyze-image', async (req, res) => {
  try {
    ...
    console.log('Analyzing image with Gemini, base64 length:', imageBase64.length);
    ...
    console.error('Error analyzing image:', error.response ? JSON.stringify(error.response.data, null, 2) : error.message);
    res.status(500).json({ 
      error: 'AI 분석 실패', 
